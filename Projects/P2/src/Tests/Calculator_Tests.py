...
# Subtraction Check
    def test_subtract_method_calculator(self) -> None:
        print("\n" , "Subtraction: ")
        CsvReader.data = []
        test_data = CsvReader('C:/Users/ChrisGuarino/Documents/IS601/Projects/P2/src/Tests/Data/Unit Test Subtraction.csv').data
        for row in test_data:
...
# Multiplication Check
    def test_multiply_method_calculator(self) -> None:
        print("\n" , "Multiplication: ")
        CsvReader.data = []
        test_data = CsvReader('C:/Users/ChrisGuarino/Documents/IS601/Projects/P2/src/Tests/Data/Unit Test Multiplication.csv').data
        for row in test_data:
...
# Division Check
    def test_division_method_calculator(self) -> None:
        print("\n" , "Division: ")
        CsvReader.data = []
        test_data = CsvReader('C:/Users/ChrisGuarino/Documents/IS601/Projects/P2/src/Tests/Data/Unit Test Division.csv').data
        for row in test_data:
...
# Square Root Check
    def test_squareroot_method_calculator(self) -> None:
        print("\n" , "Square Root: ")
        CsvReader.data = []
        test_data = CsvReader('C:/Users/ChrisGuarino/Documents/IS601/Projects/P2/src/Tests/Data/Unit Test Square Root.csv').data
        for row in test_data:
